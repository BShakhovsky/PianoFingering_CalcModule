...
void Test_PartialMonoSum(size_t tableRow, size_t tableCol, char finger1, char finger2, int16_t note1, int16_t note2)
{
	...
	else ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note1, '\2'), make_pair(note2, '\2')));
}
...
void Test_White_White(size_t tableRow, size_t tableCol, char finger1, char finger2, int16_t note1, int16_t note2)
{
	...
	{
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note1, finger1), make_pair(note2, finger1)));
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note2, finger2), make_pair(note1, finger2)));
	}
}
...
void Test_White_Black(size_t tableRow, size_t tableCol, char finger1, char finger2, int16_t note1, int16_t note2)
{
	...
	{
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note1, '\3'), make_pair(note2, '\3')));
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note2, '\4'), make_pair(note1, '\4')));
	}
}
...
void Test_Black_White(size_t tableRow, size_t tableCol, char finger1, char finger2, int16_t note1, int16_t note2)
{
	...
	{
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note1, '\4'), make_pair(note2, '\4')));
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note2, '\5'), make_pair(note1, '\5')));
	}
}
...
void Test_Black_Black(size_t tableRow, size_t tableCol, char finger1, char finger2, int16_t note1, int16_t note2)
{
	...
	{
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note1, '\2'), make_pair(note2, '\2')));
		ASSERT_EQ(16, MonoCosts().CostOfPair(make_pair(note2, '\4'), make_pair(note1, '\4')));
	}
}
