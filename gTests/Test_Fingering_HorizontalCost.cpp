...
TEST_F(HorizontalCost_F, CostOfPair)
{
	...
	ASSERT_EQ(10, HorizontalCost::Calculate(chord1, chord2, emptyChord))
		<< "single = again 2, additional pairs = 28 + 16(same finger) + 1(three-four) + 1(four on black)"
		<< " + 1(pinky on black again) + 4 = 43, total = 64 / 8 = 8";
}
